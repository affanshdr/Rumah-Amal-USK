...
export default function InfaqPage() {
  ...
  const [jenisInfaq, setJenisInfaq] = useState<string>("umum");
  ...
  return (
    <main className="flex-grow py-10 px-4 sm:px-6 lg:px-8 max-w-[1340px] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form action={submitInfaq} onSubmit={() => setSubmitting(true)} className="contents">
          ...
          <div className="lg:col-span-5 bg-white p-6 sm:p-7 rounded-2xl shadow-md border border-gray-100 space-y-4">
            ...
            {/* Jenis Infaq */}
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1.5">Kategori Infaq <span className="text-red-500">*</span></label>
              <select
                name="jenis_infaq"
                value={jenisInfaq}
                onChange={(e) => setJenisInfaq(e.target.value)}
                required
                className="w-full border border-gray-300 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:border-[#005621] bg-white"
              >
                <option value="umum">Infak Umum / Sedekah Sukarela</option>
                <option value="pendidikan">Infak Beasiswa Pendidikan</option>
                <option value="kemanusiaan">Infak Kemanusiaan & Bencana</option>
                <option value="pembangunan">Infak Pembangunan Masjid Jamik</option>
              </select>
            </div>

            {/* Jumlah Infaq */}
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1.5">Jumlah Infaq <span className="text-red-500">*</span></label>
