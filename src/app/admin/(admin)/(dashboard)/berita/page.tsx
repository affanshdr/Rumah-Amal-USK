import { getNews } from '@/actions/berita';
...
export default async function AdminBeritaPage(
  ...
  const { items, totalCount, totalPages, publishedCount, draftCount } = await getNews(page, limit);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div>
          <h1 className="text-2xl font-black text-[#000]">Berita</h1>
          <p className="text-sm text-gray-500 mt-1">
            Kelola daftar berita yang ditampilkan kepada publik
          </p>
        </div>
