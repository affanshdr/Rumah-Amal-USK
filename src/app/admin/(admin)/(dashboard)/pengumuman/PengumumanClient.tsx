...
const CATEGORIES = ["Umum", "Beasiswa", "Kegiatan", "Akademik", "Lainnya"];
...
/*KOMPONEN PREVIEW INLINE — ditampilkan di dalam modal form (split-view)*/
    ...
    <div className="flex flex-col h-full overflow-y-auto bg-gray-50 border-l border-gray-200">
      ...
      <div className="p-5 sm:p-6 overflow-y-auto flex-1 font-sans text-gray-800">
        ...
        <style>{`
          ...
          .prev-body strong { font-weight:700; }
          .prev-body em { font-style:italic; }
          .prev-body u { text-decoration:underline; }
          .prev-body s { text-decoration:line-through; }
        `}</style>
        <div
...
export default function PengumumanClient({
  ...
  const [previewingItem, setPreviewingItem] = useState<AnnouncementRow | null>(null);
  ...
  // Form values untuk preview live
  ...
  const openAdd = () => {
    ...
    setCoverPreview("");
    setContentHtml("<p></p>");
    setLiveTitle(""); setLiveExcerpt(""); setLiveCategory("Pengumuman");
          ...
          {filtered.length === 0 ? (
            <div className="py-16 text-center text-gray-400">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm font-semibold">{search ? "Tidak ada yang cocok" : "Belum ada pengumuman"}</p>
                {!search && <p className="text-xs text-gray-300">Klik &quot;Tambah Pengumuman&quot; untuk mulai.</p>}
              </div>
            </div>
          ) : (
        ...
        {totalCount > 0 && (
          <div className="px-5 py-4 border-t border-gray-100 bg-gray-50/40 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-gray-500 font-medium">
              Menampilkan <span className="font-bold text-gray-700">{filtered.length}</span> dari <span className="font-bold text-gray-700">{totalCount}</span> pengumuman
            </p>
          ...
          <div className="bg-white w-full max-w-[1400px] flex flex-col overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center justify-between px-6 py-3.5 bg-white border-b border-gray-200 shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 text-sm">{editing ? "Edit Pengumuman" : "Tambah Pengumuman Baru"}</h3>
                  <p className="text-xs text-gray-400">{editing ? "Perbarui konten pengumuman" : "Tulis dan publikasikan pengumuman baru"}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                {/* Tombol toggle preview split-view */}
                <button
                  type="button"
              ...
              >
                <div className="p-6 space-y-5 flex-1">
                  ...
                  <div className="rounded-xl border border-gray-200 bg-gray-50/70 p-4 space-y-3">
                    <label className="block text-xs font-bold text-gray-700">🖼️ Gambar Cover / Header</label>
                    {coverPreview && (
                  ...
                  {/* Judul, Tanggal, Kategori, Status */}
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-2">
                      <label className="block text-xs font-bold text-gray-700 mb-1.5">Judul Pengumuman <span className="text-red-500">*</span></label>
                      <input
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      maxLength={200}
                      placeholder="Ringkasan singkat yang muncul di daftar pengumuman…"
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 mt-1.5">
                      💡 Gunakan toolbar di atas untuk memformat teks — tidak perlu kode HTML sama sekali.
                    </p>
                  </div>
                </div>
                ...
                <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gray-50/60 shrink-0">
                  ...
                  <button type="submit" disabled={isSubmitting}
                    ...
                    {isSubmitting ? (
                      ...
                      <>💾 {editing ? "Perbarui Pengumuman" : "Simpan Pengumuman"}</>
                    )}
                  </button>
                </div>
              </form>
            ...
            <div className="p-6 sm:p-10 overflow-y-auto flex-1 font-sans text-gray-800">
              <div className="mb-6 pb-5 border-b border-gray-100">
                <div className="flex items-center gap-2 mb-2.5">
                  <span className="px-2.5 py-1 bg-emerald-50 text-emerald-700 text-[11px] font-bold rounded-full border border-emerald-100 uppercase">
                    {previewingItem.category || "Pengumuman"}
                  </span>
              ...
              <style>{`
                ...
                .prev-full strong { font-weight:700; }
                .prev-full em { font-style:italic; }
              `}</style>
