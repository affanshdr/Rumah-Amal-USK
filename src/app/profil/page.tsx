    ...
    <main className="min-h-screen bg-white pb-24">
      <div className="max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="flex items-center gap-2 text-sm font-semibold mb-10 text-gray-600">
          ...
          <span className="text-[#0b6330] font-bold">Profil</span>
        </div>
            ...
            <div className="text-gray-700 text-sm md:text-[15px] leading-relaxed space-y-4 pt-1">
              ...
              {activeTab === "visi-misi" && (
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-bold text-[#0b6330] mb-2">Visi</h3>
                    <p className="bg-green-50/60 border-l-4 border-[#0b6330] p-4 rounded-r-lg text-gray-800 font-medium">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#0b6330] mb-3">Misi</h3>
                    <ul className="space-y-2.5">
                      <li className="flex items-start gap-3">
                        <span className="w-6 h-6 rounded-full bg-[#0b6330] text-white flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span>
                        <span>Menyelenggarakan tata kelola ZISWAF yang profesional, transparan, dan akuntabel berbasis teknologi informasi.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="w-6 h-6 rounded-full bg-[#0b6330] text-white flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</span>
                      ...
                      <li className="flex items-start gap-3">
                        <span className="w-6 h-6 rounded-full bg-[#0b6330] text-white flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</span>
              ...
              {activeTab === "landasan-utama" && (
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[#0b6330] mb-2">Landasan Utama Operasional</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/60">
                      <h4 className="font-bold text-[#0b6330] mb-1">Prinsip Syariah</h4>
                    ...
                    <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/60">
                      <h4 className="font-bold text-[#0b6330] mb-1">Amanah & Transparan</h4>
                    ...
                    <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/60">
                      <h4 className="font-bold text-[#0b6330] mb-1">Kemaslahatan Umat</h4>
                    ...
                    <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/60">
                      <h4 className="font-bold text-[#0b6330] mb-1">Inovasi Berkelanjutan</h4>
              ...
              {activeTab === "fokus-program" && (
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[#0b6330] mb-2">Fokus Program Utama</h3>
                  <div className="space-y-3">
                    ...
                    <div className="p-4 rounded-xl border-l-4 border-[#0b6330] bg-green-50/40">
              ...
              {activeTab === "struktur-organisasi" && (
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[#0b6330] mb-2">Struktur Organisasi</h3>
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-5 py-3.5 text-sm transition-all duration-200 border-b border-gray-200/70 last:border-b-0 cursor-pointer ${
                      isActive
