...
export const profilDictionary = {
  ...
  ar: {
    ...
    profilSingkat: {
      title: 'Rumah Amal USK (بيت المال بمسجد جامعة سياه كوالا)',
      ...
      p2: 'تأسست مؤسسة بيت المال بمسجد جامعة سياه كوالا (Rumah Amal USK) تجسيداً لاهتمام الأسرة الأكاديمية بجامعة سياه كوالا بباندا أتشيه نحو إدارة احترافية وشفافة وموثوقة للزكاة في الحرم الجامعي والمجتمع المحيط.',
